...
class App extends Component {
  ...
  getVehicles() {
    ...
    axios.get(`${this.state.baseURL}/vehicles`)
      .then((result) => {
        toast.success("Successfully got vehicles!"); //toast.succsess('')
  ...
  getPotentialBuyers() {
    ...
    axios.get(`${this.state.baseURL}/buyers`)
      .then((res) => {
  ...
  updatePrice( priceChange, id ) {
    // axios (PUT)
    // setState with response -> vehiclesToDisplay
    axios.put(`${this.state.baseURL}/vehicles/${id}/${priceChange}`)
      .then((res) => {
        this.setState({vehiclesToDisplay: res.data.vehicles});
      });
  }
  ...
  addCar() {
    // console.log(JSON.stringify(this.state.vehiclesToDisplay))
    let newCar = {
  ...
  addBuyer() {
    ...
    //axios (POST)
    // setState with response -> buyersToDisplay
    axios.post(`${this.state.baseURL}/buyers`, newBuyer)
      .then((res) => {
  ...
  deleteBuyer( id ) {
    // axios (DELETE)
    //setState with response -> buyersToDisplay
    axios.delete(`${this.state.baseURL}/buyers/${id}`)
      .then((res) => {
        this.setState({buyersToDisplay: res.data.buyers})
  ...
  nameSearch() {
    ...
    // axios (GET)
    // setState with response -> buyersToDisplay
    axios.get(`${this.state.baseURL}/buyers?name=${searchLetters}`)
      .then((res) => {
        this.setState({buyersToDisplay: res.data})
      });
  }
  ...
  byYear() {
    ...
    // axios (GET)
    // setState with response -> vehiclesToDisplay
    axios.get(`${this.state.baseURL}/vehicles?year=${year}`)
      .then((res) => {
        this.setState({vehiclesToDisplay: res.data})
      })
  }
